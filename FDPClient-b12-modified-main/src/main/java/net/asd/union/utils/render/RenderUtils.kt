...
import net.asd.union.features.module.modules.visual.CombatVisuals.DOUBLE_PI
import net.asd.union.features.module.modules.visual.CombatVisuals.colorBlueTwoValue
import net.asd.union.features.module.modules.visual.CombatVisuals.colorBlueValue
import net.asd.union.features.module.modules.visual.CombatVisuals.colorGreenTwoValue
import net.asd.union.features.module.modules.visual.CombatVisuals.colorGreenValue
import net.asd.union.features.module.modules.visual.CombatVisuals.colorRedTwoValue
import net.asd.union.features.module.modules.visual.CombatVisuals.colorRedValue
import net.asd.union.features.module.modules.visual.CombatVisuals.start
import net.asd.union.ui.font.Fonts
import net.asd.union.utils.block.block
import net.asd.union.utils.block.center
import net.asd.union.utils.block.toVec
import net.asd.union.utils.client.ClientThemesUtils.getColor
import net.asd.union.utils.client.MinecraftInstance
import net.asd.union.utils.extensions.*
import net.asd.union.utils.render.ColorUtils.setColour
import net.asd.union.utils.render.animation.AnimationUtil
import net.asd.union.utils.render.animation.AnimationUtil.easeInOutQuadX
import net.asd.union.utils.render.shader.UIEffectRenderer.drawTexturedRect
