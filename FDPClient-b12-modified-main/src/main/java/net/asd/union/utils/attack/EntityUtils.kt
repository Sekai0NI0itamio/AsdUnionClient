 ...
 */
package net.asd.union.utils.attack
...
import net.asd.union.ui.font.GameFontRenderer.Companion.getColorIndex
import net.asd.union.utils.client.MinecraftInstance
import net.asd.union.utils.extensions.*
import net.asd.union.utils.kotlin.StringUtils.contains
            ...
            if (invisibleValue || !entity.isInvisible) {
                if (playerValue && entity is EntityPlayer) {
                    if (canAttackCheck) {
                        ...
                        // Check if KillAuraTargeter is active - if so, only allow the targeted entity
                        val killAuraTargeter = net.asd.union.features.module.modules.combat.KillAuraTargeter
                        if (killAuraTargeter.state && killAuraTargeter.isTargetSelected()) {
                            if (entity != killAuraTargeter.getTargetEntity()) {
                                return false
                            }
                        }
