...
import net.asd.union.features.module.modules.combat.FakeLag
import net.asd.union.features.module.modules.combat.Velocity
import net.asd.union.injection.implementations.IMixinEntity
import net.asd.union.utils.extensions.currPos
...
object PacketUtils : MinecraftInstance, Listenable {
    ...
    @JvmStatic
    fun sendPacketNoEvent(packet: Packet<*>) = sendPacket(packet, false)
