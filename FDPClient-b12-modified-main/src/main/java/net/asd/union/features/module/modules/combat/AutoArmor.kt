...
import net.asd.union.features.module.modules.player.InventoryCleaner.canBeRepairedWithOther
import net.asd.union.utils.client.PacketUtils.sendPacket
import net.asd.union.utils.inventory.ArmorComparator.getBestArmorSet
import net.asd.union.utils.inventory.InventoryManager
import net.asd.union.utils.inventory.InventoryManager.autoArmorCurrentSlot
import net.asd.union.utils.inventory.InventoryManager.autoArmorLastSlot
import net.asd.union.utils.inventory.InventoryManager.canClickInventory
import net.asd.union.utils.inventory.InventoryManager.hasScheduledInLastLoop
import net.asd.union.utils.inventory.InventoryManager.passedPostInventoryCloseDelay
import net.asd.union.utils.inventory.InventoryUtils.isFirstInventoryClick
import net.asd.union.utils.inventory.InventoryUtils.serverOpenInventory
import net.asd.union.utils.inventory.InventoryUtils.toHotbarIndex
import net.asd.union.utils.inventory.SilentHotbar
import net.asd.union.utils.inventory.hasItemAgePassed
import net.asd.union.utils.timing.TickedActions.awaitTicked
import net.asd.union.utils.timing.TickedActions.clickNextTick
import net.asd.union.utils.timing.TickedActions.isTicked
...
object AutoArmor : Module("AutoArmor", Category.COMBAT, hideModule = false) {
    ...
    private suspend fun shouldOperate(onlyHotbar: Boolean = false): Boolean {
        while (true) {
            ...
            // If there is no delay, very weird things happen: https://www.guilded.gg/Itamio/groups/1dgpg8Jz/channels/034be45e-1b72-4d5a-bee7-d6ba52ba1657/chat?messageId=94d314cd-6dc4-41c7-84a7-212c8ea1cc2a
            delay(50)
        }
    }
