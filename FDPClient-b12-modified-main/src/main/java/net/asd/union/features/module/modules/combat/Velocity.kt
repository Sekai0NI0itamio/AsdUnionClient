...
object Velocity : Module("Velocity", Category.COMBAT, hideModule = false) {
    ...
    val onGameTick = handler<GameTickEvent> {
        ...
        if (mode != "Click" || thePlayer.hurtTime != hurtTimeToClick || ignoreBlocking && (thePlayer.isBlocking || AuraBridge.isBlocking()))
            return@handler
    ...
    val onTick = handler<GameTickEvent> {
        ...
        // Timer Abuse (https://github.com/Itamio/LiquidBounce/issues/2519)
