...
import net.asd.union.features.module.modules.movement.flymodes.aac.*
import net.asd.union.features.module.modules.movement.flymodes.blocksmc.BlocksMC
import net.asd.union.features.module.modules.movement.flymodes.blocksmc.BlocksMC2
import net.asd.union.features.module.modules.movement.flymodes.hypixel.BoostHypixel
import net.asd.union.features.module.modules.movement.flymodes.hypixel.FreeHypixel
import net.asd.union.features.module.modules.movement.flymodes.hypixel.Hypixel
import net.asd.union.features.module.modules.movement.flymodes.ncp.NCP
import net.asd.union.features.module.modules.movement.flymodes.ncp.OldNCP
import net.asd.union.features.module.modules.movement.flymodes.other.*
import net.asd.union.features.module.modules.movement.flymodes.spartan.BugSpartan
import net.asd.union.features.module.modules.movement.flymodes.spartan.Spartan
import net.asd.union.features.module.modules.movement.flymodes.spartan.Spartan2
import net.asd.union.features.module.modules.movement.flymodes.vanilla.DefaultVanilla
import net.asd.union.features.module.modules.movement.flymodes.vanilla.SmoothVanilla
import net.asd.union.features.module.modules.movement.flymodes.vanilla.Vanilla
import net.asd.union.features.module.modules.movement.flymodes.verus.Verus
import net.asd.union.features.module.modules.movement.flymodes.verus.VerusGlide
import net.asd.union.features.module.modules.movement.flymodes.vulcan.Vulcan
import net.asd.union.features.module.modules.movement.flymodes.vulcan.VulcanGhost
import net.asd.union.features.module.modules.movement.flymodes.vulcan.VulcanOld
import net.asd.union.utils.client.PacketUtils.sendPacket
import net.asd.union.utils.rotation.RotationSettings
import net.asd.union.utils.extensions.stop
