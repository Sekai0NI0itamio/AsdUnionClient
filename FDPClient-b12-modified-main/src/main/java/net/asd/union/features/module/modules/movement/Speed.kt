...
import net.asd.union.features.module.modules.movement.speedmodes.aac.AACHop3313
import net.asd.union.features.module.modules.movement.speedmodes.aac.AACHop350
import net.asd.union.features.module.modules.movement.speedmodes.aac.AACHop4
import net.asd.union.features.module.modules.movement.speedmodes.aac.AACHop5
import net.asd.union.features.module.modules.movement.speedmodes.hypixel.HypixelHop
import net.asd.union.features.module.modules.movement.speedmodes.hypixel.HypixelLowHop
import net.asd.union.features.module.modules.movement.speedmodes.intave.IntaveHop14
import net.asd.union.features.module.modules.movement.speedmodes.intave.IntaveTimer14
import net.asd.union.features.module.modules.movement.speedmodes.matrix.MatrixHop
import net.asd.union.features.module.modules.movement.speedmodes.matrix.MatrixSlowHop
import net.asd.union.features.module.modules.movement.speedmodes.matrix.MatrixSpeeds
import net.asd.union.features.module.modules.movement.speedmodes.matrix.OldMatrixHop
import net.asd.union.features.module.modules.movement.speedmodes.ncp.*
import net.asd.union.features.module.modules.movement.speedmodes.other.*
import net.asd.union.features.module.modules.movement.speedmodes.spartan.SpartanYPort
import net.asd.union.features.module.modules.movement.speedmodes.spectre.SpectreBHop
import net.asd.union.features.module.modules.movement.speedmodes.spectre.SpectreLowHop
import net.asd.union.features.module.modules.movement.speedmodes.spectre.SpectreOnGround
import net.asd.union.features.module.modules.movement.speedmodes.verus.*
import net.asd.union.features.module.modules.movement.speedmodes.vulcan.VulcanGround288
import net.asd.union.features.module.modules.movement.speedmodes.vulcan.VulcanHop
import net.asd.union.features.module.modules.movement.speedmodes.vulcan.VulcanLowHop
