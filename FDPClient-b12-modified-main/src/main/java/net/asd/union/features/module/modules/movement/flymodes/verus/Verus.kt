 ...
 */
package net.asd.union.features.module.modules.movement.flymodes.verus

import net.asd.union.event.JumpEvent
import net.asd.union.event.PacketEvent
import net.asd.union.features.module.modules.movement.Flight.boostMotion
import net.asd.union.features.module.modules.movement.Flight.boostTicksValue
import net.asd.union.features.module.modules.movement.Flight.damage
import net.asd.union.features.module.modules.movement.Flight.timerSlow
import net.asd.union.features.module.modules.movement.Flight.yBoost
