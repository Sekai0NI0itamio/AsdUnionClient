...
import net.asd.union.utils.render.RenderUtils.checkSetupFBO
...
import net.asd.union.utils.render.RenderUtils.renderFive
import net.asd.union.utils.render.RenderUtils.renderFour
import net.asd.union.utils.render.RenderUtils.renderOne
import net.asd.union.utils.render.RenderUtils.renderThree
import net.asd.union.utils.render.RenderUtils.renderTwo
import net.asd.union.utils.render.RenderUtils.setColor
...
object StorageESP : Module("StorageESP", Category.VISUAL) {
    ...
    private fun getColor(tileEntity: TileEntity): Color? {
        return if (espColorMode == "Custom") {
            ...
            when {
                chest && tileEntity is TileEntityChest -> Color(0, 66, 255)
                enderChest && tileEntity is TileEntityEnderChest -> Color.MAGENTA
