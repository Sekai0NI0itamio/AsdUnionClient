...
class GuiScripts(private val prevGui: GuiScreen) : AbstractScreen() {
    ...
    override fun actionPerformed(button: GuiButton) {
        when (button.id) {
            ...
            5 -> try {
                MiscUtils.showURL("https://github.com/Itamio/Documentation/blob/master/md/scriptapi_v2/getting_started.md")
            } catch (e: Exception) {
                ...
                MiscUtils.showErrorPopup(
                    ...
                    "github.com/Itamio/Documentation/blob/master/md/scriptapi_v2/getting_started.md"
                )
            }
