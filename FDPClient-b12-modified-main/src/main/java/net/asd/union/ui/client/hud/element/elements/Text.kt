...
import net.asd.union.FDPClient.CLIENT_AUTHOR
import net.asd.union.FDPClient.CLIENT_NAME
import net.asd.union.FDPClient.clientCommit
...
import net.asd.union.ui.font.GameFontRenderer
import net.asd.union.utils.attack.CPSCounter
import net.asd.union.utils.client.PPSCounter
import net.asd.union.utils.client.ServerUtils
import net.asd.union.utils.extensions.getPing
...
import net.asd.union.utils.render.RenderUtils.drawRoundedBorder
    ...
    fun getReplacement(str: String): Any? {
        ...
        if (thePlayer != null) {
            when (str.lowercase()) {
                ...
                "block", "blocking" -> return (thePlayer.heldItem?.item is ItemSword && (AuraBridge.isBlocking() || thePlayer.isUsingItem || thePlayer.isBlocking))
