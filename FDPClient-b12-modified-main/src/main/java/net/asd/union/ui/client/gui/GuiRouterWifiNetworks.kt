...
class GuiRouterWifiNetworks(private val prevGui: GuiScreen) : AbstractScreen() {
    ...
    override fun initGui() {
        ...
        networksList = NetworksList(this, top = 62, bottom = bottomY - 10)
        networksList.registerScrollButtons(7, 8)

        refreshButton = +GuiButton(1, centerX, bottomY, 98, 20, "Refresh")
        connectButton = +GuiButton(2, centerX + 102, bottomY, 98, 20, "Connect")
